...
public class reminder_model {
    ...
    public reminder_model(String user_id, String date, String mtime, String reminder_title, int year, int month, int day, int hour, int minute, Boolean set_active, Boolean hourly, Boolean daily, Boolean weekly, Boolean monthly, Boolean yearly, String reminder_content){
