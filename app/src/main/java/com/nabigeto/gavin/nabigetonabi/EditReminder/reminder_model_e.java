...
/**
 * Created by Gavin on 7/27/2018.
 */

public class reminder_model_e {
    ...
    public reminder_model_e(){};

    public reminder_model_e(String user_id, String date, String mtime, String reminder_title, int year, int month, int day, int hour, int minute, Boolean set_active, Boolean hourly, Boolean daily, Boolean weekly, Boolean monthly, Boolean yearly, String reminder_content){
    ...
    public reminder_model_e(String user_id, String date, String mtime, String reminder_title, Boolean set_active, String reminder_content){
    ...
    public String getSet_active(String set_active) {
        return set_active;
    }

    public String getReminder_content(String reminder_content) {
        return reminder_content;
    }
**/
}
