...
public class reminder_sqlite_update {
...
**/
        ...
        Log.v("Gavin", "Reminder_sqlite_update " + "3");
/**
        Alarm_Restart_db_Helper helper = new Alarm_Restart_db_Helper(context);

        SQLiteDatabase db = helper.getWritableDatabase();

        db.insert(Alarm_Restart_Contract.AlarmInfo.TABLE_NAME_F, null ,alarmValues);
**/
        Log.v("Gavin", "Reminder_sqlite_update " + "4");
        ...
        Log.v("Gavin", "Reminder_sqlite_update " + "5");
